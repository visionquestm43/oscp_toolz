...
with open('cookz.txt','w') as f:
    print("session.cookies: ", cookieDict, file=f)
...
for z in range(6,10):
    ...
    sqli1_Content = sqli1_search.content
    ...
    with open('sqlcontent.txt', 'a') as f:
        print("sessionContent (%s): " % (z), sqli1_response.split('<td colspan="5" width="580">'), file=f)
