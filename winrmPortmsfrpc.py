...
outputFile = '/root/oscplab/labtargets/dot229/dot229winrm.txt'
domain = 'goggins.local'
RHOSTS = '192.168.1.229' #IP address of target
...
Start postgressql.service, start msfconsole,  load msgrpc User='msf' Pass='<password in line 24>'
'''
...
client.login('msf', 'abc123')  #Use this username/password to load the msgrpc module in the msfconsole
sess = client.call('console.create')
console_id = sess[b'id']  # Added 'b'
# print(sess.keys()) Used for troubleshooting and confirmed the key name(s)

deleteMsfWorkspace = "workspace -d mac10\n"
createMsfWorkspace = "workspace -a mac10\n"
client.call('console.write', [console_id, deleteMsfWorkspace])
